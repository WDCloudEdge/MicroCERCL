...
def collect_graph(config: Config, _dir: str, collect: bool) -> Dict[str, nx.DiGraph]:
    ...
    node_center: Dict[str, str] = {'izbp16opgy3xucvexwqp9dz': 'cloud',
                                   ...
                                   'server-3': 'edge-2',
                                   'dell2018': 'edge-2'}
    masks = ['ingress', 'unknown', 'load-pod', 'load-pod-cloud', 'istio-ingressgateway', 'productpage-v1-edge', 'productcatalogservice-edge', 'recommendationservice-edge', 'carts-cloud-hxv26', 'carts-cloud-jlt67', 'carts-cloud-jjn2j', 'carts-cloud-czcwz', 'horsecoder-pay-deployment-f5b6d5d4b-959jd', 'horsecoder-pay-deployment-f5b6d5d4b-hjrd4', 'horsecoder-pay-deployment-f5b6d5d4b-sbj2b', 'horsecoder-pay-deployment-f5b6d5d4b-ndgpx', 'horsecoder-pay-deployment-f5b6d5d4b-t7n24', 'horsecoder-pay-web-deployment-855fb4bb88-mnk8c']
